...
<header class="lyear-header text-center" style="background-image:url(images/astronaut.jpeg);">
  <div class="lyear-header-container">
    ...
    <div id="navigation" class="collapse navbar-collapse flex-column">
      ...
      <div>
        <a href="" class="btn btn-primary btn-lg active" role="button" aria-pressed="true">登錄</a>
      </div>
	</div>
  </nav>
  </div>
          ...
          <div class="lyear-sidebar">
            <div class="my-2 my-md-3">
              <form class="lyear-search-form form-inline justify-content-center pt-3">
                <input type="text" id="semail" name="semail1" class="form-control border border-4 border-primary mr-md-1 text-dark" placeholder="搜索关键词" />
              </form>
            </div>
